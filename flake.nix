  ...
  outputs = inputs @ {
    ...
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      perSystem = {pkgs, ...}: let
        ...
        renovate = ["k0sproject/k0s" "1.35.3+k0s.0"]; # github-releases
        ...
        packages.default = with pkgs; let
          module = buildGoModule rec {
            ...
            src = fetchFromGitHub {
              inherit owner repo;
              rev = "v${version}";
              hash = "sha256-LNy1PYQJ0xyufXUKZPf2Z3KZaRcJJTTAAJPm39WKa7g=";
            };

            vendorHash = "sha256-hEMTg8L0n1evVzR22W+RFNvpymP/dsQhghNoc1hSEbY=";
        ...
        apps = let
          ...
          apkBuildImage = pkgs.dockerTools.buildImage {
            ...
            fromImage = pkgs.dockerTools.pullImage (let
              renovate = ["alpine" "3.23.2" "sha256:865b95f46d98cf867a156fe4a135ad3fe50d2056aa3f25ed31662dff6da4eb62"]; # docker

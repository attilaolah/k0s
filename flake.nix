  ...
  outputs = inputs @ {
    ...
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      perSystem = {pkgs, ...}: let
        ...
        renovate = ["k0sproject/k0s" "1.33.1+k0s.0"]; # github-releases
        ...
        packages.default = with pkgs; let
          module = buildGoModule rec {
            ...
            src = fetchFromGitHub {
              inherit owner repo;
              rev = "v${version}";
              hash = "sha256-O4mRu7HZk8nEG9w++61TYFr8zupaDvhwZ6Y1Jm2FXKo=";
            };

            vendorHash = "sha256-6EGIQ5xs/KZgkz1rvRc+5J1ppDAD7SUUco7gJItr8oo=";
        ...
        apps = let
          ...
          apkBuildImage = pkgs.dockerTools.buildImage {
            ...
            fromImage = pkgs.dockerTools.pullImage (let
              renovate = ["alpine" "3.21.3" "sha256:a8560b36e8b8210634f77d9f7f9efd7ffa463e380b75e2e74aff4511df3ef88c"]; # docker

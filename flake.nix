  ...
  outputs = inputs @ {
    ...
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      perSystem = {pkgs, ...}: let
        ...
        renovate = ["k0sproject/k0s" "1.34.1+k0s.0"]; # github-releases
        ...
        packages.default = with pkgs; let
          module = buildGoModule rec {
            ...
            src = fetchFromGitHub {
              inherit owner repo;
              rev = "v${version}";
              hash = "sha256-ZbryNgi8FSdGEgpJ+OaPof71qlkAL6n05lmzD/j2d2c=";
            };

            vendorHash = "sha256-kmQeSeVl/8Wy37rjMonCBfbxSseX45NG9HViuh1phdM=";
        ...
        apps = let
          ...
          apkBuildImage = pkgs.dockerTools.buildImage {
            ...
            fromImage = pkgs.dockerTools.pullImage (let
              renovate = ["alpine" "3.22.2" "sha256:4b7ce07002c69e8f3d704a9c5d6fd3053be500b7f1c69fc0d80990c2ad8dd412"]; # docker
